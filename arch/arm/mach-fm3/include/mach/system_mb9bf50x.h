...
//#define CLOCK_SETUP               0   // <<< Define clock setup here
 ...
 ******************************************************************************/    
#ifdef CLK_16M
#define __CLKMO        (16000000UL)   // <<< External  16MHz Crystal
#else
 ...
 ******************************************************************************/    
#ifdef CLK_16M
#define PLL_CTL2_Val          0x00000004    // <<< Define PLL_CTL2 here	(16MHz)
#else
#define PLL_CTL2_Val          0x00000013    // <<< Define PLL_CTL2 here (4MHz)
#endif
